...
// DX8Backend is the reference implementation of IRenderBackend that forwards
// every virtual method to the existing DX8Wrapper static facade. Pure
// adaptation, no new rendering logic. Shape mirrors upstream TheSuperHackers
// PR #2613 (bobtista).
